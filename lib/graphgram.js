...
// special terms used in label expressions
var evalKey = '$eval',
...
function labelMatch (gLabel, sLabel, opts) {
  ...
  if (typeof(sLabel) === 'string') {
    ...
    if (sLabel[equalsKey])
      return labelMatch (gLabel, sLabel[equalsKey], merge (opts, {exact:true}))
    if (sLabel[containsKey])
      return labelMatch (gLabel, sLabel[containsKey], merge (opts, {exact:false}))
    if (sLabel[notKey])
