...
Context.prototype.newLabel = function (isomorph, expr) {
  ...
  var matches = Object.keys(isomorph.match).sort().reduce (function (arr, id) {
    return arr.concat (isomorph.match[id])
  }, [])
  return expr.replace (/\\(\d+)/g, function (_m, n) { return matches[parseInt(n)] })
}
